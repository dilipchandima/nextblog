  ...
  return (
    <>
      <div className="border-b-2 p-4 border-gray-700">
        <Link
          className="flex w-40 h-10 items-center gap-2 text-gray-300 hover:text-purple-400"
          href="/blog"
        >
          <FiChevronLeft /> BLOGS
        </Link>
      ...
      <div className="bg-gray-100 dark:bg-gray-850 mt-20 mb-20 py-14 px-10 rounded-2xl">

    ...
    <div className="flex flex-wrap">
      {blogs.map(({ id, title, date, description, image, tags, slug }: any) => (
        ...
        >
          <Link href={`/blog/${slug}`}>
            <div
              className="w-full h-full  border-2 p-6 rounded-xl border-gray-300 dark:border-gray-600  hover:bg-gray-100 hover:dark:bg-gray-850 hover:dark:border-gray-500 hover:border-gray-400 transition duration-200"
              key={id}
            >
